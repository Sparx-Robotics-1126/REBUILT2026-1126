...
public final class Lights {
    ...
    private static final int SIDE_LEFT_BASE = 0 * LENGTH;
    private static final int TOP_LEFT_BASE = 1 * LENGTH;
    private static final int TOP_RIGHT_BASE = 2 * LENGTH;
        ...
        public Command setSolidRed() {
         ...
         public Command setSolidBlue() {
            return commandBuilder()
                ...
                .onEnd(() -> set(Color.OFF))
                .ignoringDisable(true)
                .withName("Lights.TopLeft.setSolidBlue()");
        }
    ...
    public final class TopRight extends GRRSubsystem {
        ...
        public Command setSolidBlue() {
            return commandBuilder()
                ...
                .onEnd(() -> set(Color.OFF))
                .ignoringDisable(true)
                .withName("Lights.TopRight.setSolidBlue()");
        }
