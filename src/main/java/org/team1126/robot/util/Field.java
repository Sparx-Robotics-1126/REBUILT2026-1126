...
public final class Field {
    ...
    // );
    public static final ExtPose WAYPOINT_GOAL_NEAR = new ExtPose(new Pose2d(1.0, CENTER_Y, Rotation2d.k180deg));
    ...
    public static final double SHOOTING_RANGE_RADIUS = 2.835;
