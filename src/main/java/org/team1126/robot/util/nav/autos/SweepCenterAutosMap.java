 ...
 */
public final class SweepCenterAutosMap extends NorthDefaultNavigator {

    private static SweepCenterAutosMap instance;

    public static void init(Swerve swerve) {
        instance = new SweepCenterAutosMap(swerve);
    }

    public static SweepCenterAutosMap get() {
        if (instance == null) {
            return null;
        }
     ...
     */
    private SweepCenterAutosMap(Swerve swerve) {
        this.swerve = swerve;
