...
public class GoOutpostAndToss extends BaseAutosRoutine {
    ...
    private static GoOutpostAndToss instance;

    public static void init(Robot robot) {
        instance = new GoOutpostAndToss(COMMAND_NAME, DISPLAY_NAME, ABBREVIATION, robot);
    }

    public static GoOutpostAndToss get() {
        if (instance == null) {
            return null;
        }
        return instance;
    ...
    private GoOutpostAndToss(String commandName, String displayName, String abbreviatedName, Robot robot) {
